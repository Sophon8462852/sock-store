...
<div class="col-md-4">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input name="cat_eng_title" type="text" class="form-control">
        </div>
		
		<div class="form-group">
            <label for="category-swe-title">Title (swedish)</label>
            <input name="cat_swe_title" type="text" class="form-control">
        </div>

	<div class="form-group">
	      <label for="cat_order">Order</label>
   <input name="cat_order" type="number" class="form-control"> 
	</div>
